...
<head>
  ...
  <title>Gestión de Estudiantes - Administrador</title>
  ...
  <style>
    ...
    .admin-btn:hover {
      ...
      box-shadow: 0 4px 12px rgba(92, 158, 173, 0.2);
    }
...
<body>
  <div class="glass-container">
    <div class="header">
      <h1><i class="fas fa-user-cog me-2"></i>Gestión de Formularios - Administrador</h1>
      <p class="subtitle">Sistema de administración de estudiantes</p>
    </div>

    <div class="admin-actions">
      <a href="{{ route('asistente') }}" class="admin-btn">
        <i class="fas fa-users"></i> Panel de Asistente
      </a>
  ...
  <script>
    ...
    // Simulación de rol
    const esAdmin = true; // si fuera false, no vería botones de edición/eliminación
        ...
        .forEach((est, index) => {
          ...
          row.innerHTML = `
            ...
            <td>
              ...
              ${esAdmin ? `
                <button class="btn edit-btn" onclick="editar(${index})"><i class="fas fa-edit"></i> Editar</button>
